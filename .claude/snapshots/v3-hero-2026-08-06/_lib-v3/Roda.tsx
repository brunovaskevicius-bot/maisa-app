...
export function Roda({ children }: { children: ReactNode }) {
  return (
    ...
    >
      ...
      >
        {/* AGRUPADO POR ANEL, e o agrupamento é o que conserta um defeito visível.
            A opacidade do anel de fora precisa valer para o CONJUNTO, não para
            cada cartão: como os cartões se sobrepõem, uma opacidade por cartão
            faz cada um deixar ver o de baixo através de si, e a coroa externa
            vira um borrão translúcido em vez de uma pilha de fotos. Num grupo, o
            navegador compõe os cartões opacos primeiro e só então esmaece o
            resultado inteiro. O <Morph> respeita isso: ele escreve por cartão só
            o portão da costura, nunca o recuo do anel. */}
