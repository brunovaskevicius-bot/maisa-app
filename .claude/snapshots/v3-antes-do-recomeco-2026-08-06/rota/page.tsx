...
import { Fecho } from "../../_lib/barbeiros/v3/Fecho";
  ...
  return (
    <World icp="barbeiros" className="lp-v3">
      <main id="conteudo" tabIndex={-1}>
        <Dobra />
        <Ato2 />
        {/* O fecho é SEÇÃO IRMÃ, não uma terceira batida dentro do <Ato2/>: aquela
            seção é `isolation: isolate` porque serve de backdrop ao `multiply` da
            figura, e uma faixa de ouro sangrando dentro do grupo isolado tingiria a
            foto na próxima mudança de altura. Ver o cabeçalho de Fecho.tsx. */}
        <Fecho />
      </main>
    </World>
  );
