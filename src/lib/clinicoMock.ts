...
export const pacientes: Paciente[] = [
  ...
  { id: "p4",  nome: "Bruno Vaskevicius", telefone: "11983457788", email: "joao.pereira@email.com",   cpf: "545.739.088-89", tipoAtendimento: "PRESENCIAL", status: "ATIVO",   diagnostico: "Estresse",           dataInicio: "2025-02-12" }, // NF teste: tomador CPF real/existente (buildBody detecta 11 dígitos -> CPF). TEMPORÁRIO — reverter após validar
