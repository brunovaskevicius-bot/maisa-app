...
export function Duelo() {
  return (
    <section className="lp3-d" aria-labelledby="lp3-d-titulo">
      ...
      {/* A CHAMADA VEM DEPOIS DA ARENA E ANTES DA FONTE, e a ordem é a do
          argumento: a arena acabou de mostrar que a maisa custa menos que
          contratar alguém, e este é o instante em que a conclusão vale um clique.
          Pôr o botão DEPOIS da letra miúda o deixaria pendurado atrás de uma nota
          de rodapé — a pessoa decide no número, não na citação da fonte. */}
      <Chamada className="lp3-ch--duelo">{CTA_SECAO.duelo}</Chamada>
